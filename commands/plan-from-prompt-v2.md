...
3. **Present final summary** to user:
   ```
   The implementation plan is complete and saved to plans/[filename].md
   ...
   Is there anything you'd like me to clarify or adjust in the plan?
   ```
4. **Wait for user response**
5. **STOP HERE** - Do not proceed beyond this point
